...
![nba_API](./images/Game_Notification_Architecture.png)
...
```bash
git clone https://github.com/Peter-Mwangi254/30-day-DevOps-Challenge/tree/main/NBA-Game-Day-Notification
cd NBA-Game-Day-Notification
```
